...
export function AppProvider({ children }: { children: ReactNode }) {
    ...
    // Every `useApp()` consumer (~59 across the app) re-renders whenever this identity
    // changes, so an unmemoized object literal here — recreated on every AppProvider
    // render, including ones caused by its own local useState hooks rather than a
    // dispatch — was forcing a full app re-render on anything that touched AppProvider.
