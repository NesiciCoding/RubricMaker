...
import { FileText, BookOpen, Video, ExternalLink, Layers, ListChecks, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {sorted.map((flash) => {
                ...
                const expanded = expandedId === flash.id;
                const hasContent = !!flash.content;

                function toggle() {
                    onOpen(flash);
                    if (hasContent) setExpandedId(expanded ? null : flash.id);
                }
                    ...
                    >
                                ...
                                >
                                    ...
                                    {hasContent && (
                                        <span className="text-xs" style={{ color: 'var(--accent)' }}>
                                            ...
                                            {expanded
                                                ? t('newsFlashes.collapse_article')
                        ...
                        {expanded && flash.content && (
                            <div
                                ...
                                dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(flash.content) }}
                            />
                        )}
                    </div>
                );
