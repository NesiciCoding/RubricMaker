                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
                        ...
                        {!timerLocked ? (
                            <div style={{ display: 'flex', gap: 8 }}>
                                {!timerRunning ? (
                                    <button
                                        className="btn btn-primary btn-sm speaking-timer-btn"
                                    ...
                                    <button
                                        className="btn btn-secondary btn-sm speaking-timer-btn"
                ...
                <div className="card" data-tour="sp-pronunciation" style={{ marginBottom: 24 }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 16 }}>
                        {ERROR_TYPES.map((type) => (
                            <button
                                key={type}
                                className="btn btn-secondary btn-sm speaking-error-btn"
