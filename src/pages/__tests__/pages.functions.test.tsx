...
vi.mock('../../context/AppContext', () => ({
    ...
    useStudents: () => ({ students: currentApp.students }),
    useClasses: () => ({ classes: currentApp.classes }),
    useGrading: () => ({
        studentRubrics: currentApp.studentRubrics,
        attachments: currentApp.attachments,
        saveStudentRubric: currentApp.saveStudentRubric,
        deleteStudentRubric: currentApp.deleteStudentRubric,
        restoreStudentRubric: currentApp.restoreStudentRubric,
        addAttachment: currentApp.addAttachment,
    }),
