...
**Status:** Phases 36, 37 (37.1 + 37.2), 38, and 40 implemented (40 = grading Cards/Grid toggle, criterion×level grid with focused-criterion detail panel, settings-cog header menu, sub-item chips + override control, comment quick-chips, criterion-letter+number chords). Phase 39 is intentionally skipped (see the "Phase 39 — intentionally not used" section below). Phases 41–42 remain proposed.
